...
# 运行重建测试（对每个模型）
for model in DINOv2-B DINOv2-B_512 MAE SigLIP2; do
    echo "=========================================="
    echo "测试模型: $model"
    echo "=========================================="
    ...
    python $Weather_DIR/reconstruction/create_rae_reconstruction_comparison.py \
        --original-dir $Weather_DIR/reconstruction/weather_images \
        --reconstructed-dir $Weather_DIR/reconstruction/outputs/rae_reconstruction/recon_samples_${model}/RAE-pretrained-bs4-fp32 \
