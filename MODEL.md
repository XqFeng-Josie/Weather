...
3. [WeatherDiff 模块](#weatherdiff-模块)
   - [VAE (Stable Diffusion VAE)](#vae-stable-diffusion-vae)
...
1. **VAE编码**: 将输入图像编码到潜空间（压缩64倍）
2. **潜空间预测**: U-Net在潜空间中预测未来帧
3. **VAE解码**: 将预测的潜向量解码回像素空间
...
- **Latent U-Net**: 适合512×512大尺寸，显存友好
