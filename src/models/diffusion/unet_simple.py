...
class SimpleUNet(nn.Module):
    ...
    def __init__(
        ...
        self.dec2 = SimpleBlock(base_channels * 2 + base_channels * 4, base_channels * 2, time_dim)  # up + skip
        
        self.up1 = nn.ConvTranspose2d(base_channels * 2, base_channels, 2, stride=2)
        self.dec1 = SimpleBlock(base_channels + base_channels * 2, base_channels, time_dim)  # up + skip
