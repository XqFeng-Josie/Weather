...
def main():
    ...
    print(f"✓ Ensemble predictions saved to {output_dir}/ensemble_predictions_reevaluated.npy")
    ...
    plt.tight_layout()
    plt.savefig(output_dir / "ensemble_evaluation_spread.png", dpi=300, bbox_inches="tight")
    plt.close()
