...
def train(model, optimizer):
    for i, (x_mb, y_mb) in tqdm(enumerate(train_loader), total=len(train_loader), desc="Training"):
            ...
            print("step: ", i, "loss: ", loss.item(), "loss_recon: ", loss_recon.item(), "loss_KL: ", loss_KL.item())
            loss.backward()
            optimizer.step()
